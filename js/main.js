...
var slides = [
		{
			...
			footerText: 'In Juanary 2011, after a decade of digital, we opened the doors to our temple. Follow our noble eightfold path to digital enlightenment here.',
...
function goToSlide(index) {
	...
	var $footerButtonActive = document.getElementsByClassName('footer__button--active')[0];
